...
const ChatBot = () => {
  ...
  const [messages, setMessages] = useState<Message[]>([
    { role: 'model', text: 'Namaste! I am your AI Study Assistant. Ask me anything about your course in Hinglish!' }
  ]);
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents: contents,
        config: {
          systemInstruction: "You are a friendly and knowledgeable tutor for Indian students. You must explain concepts in Hinglish (a mix of Hindi and English) to make them easy to understand. Use emojis, be encouraging, and keep explanations concise but clear.",
        },
      });
      ...
      setMessages(prev => [...prev, { role: 'model', text: "Network issue. Thoda wait karke try karo!" }]);
    } finally {
      setIsLoading(false);
    }
  };
        ...
        <div className="fixed bottom-24 right-6 w-[90vw] max-w-[380px] h-[550px] max-h-[70vh] bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl z-50 flex flex-col border border-white/50 overflow-hidden animate-fade-in origin-bottom-right ring-1 ring-black/5">
          ...
          <div className="bg-gradient-to-r from-brand to-purple-600 p-4 flex justify-between items-center text-white shadow-lg">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-display font-bold text-base">AI Tutor (Hinglish)</h3>
